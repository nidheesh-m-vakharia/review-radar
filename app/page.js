        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pr-8 lg:pt-4">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-2 text-3xl font-bold tracking-tight text-text-950 sm:text-4xl">A better workflow</p>
              <p className="mt-6 text-lg leading-8 text-background-600 text-pretty">
                Unlock the power of informed shopping with Review Radar. Effortlessly find the best review videos for your Amazon products and make confident decisions.              </p>
